...
const validInput: CustomerInput = { name: 'Test Customer', phone: '9876543210', email: '', alternatePhone: '', customerType: 'Individual', status: 'Pending', address: 'Test address', permanentAddress: '', dateOfBirth: '', gender: '', occupation: '', businessType: '', taxIdentifier: '', identityType: 'Aadhaar', identityReference: '', kycMethod: 'Document review', kycVerifiedOn: '', amlRiskCategory: 'Standard', sourceOfFunds: '', communicationPreference: 'SMS', branch: 'Yavatmal Main Branch', nomineeName: 'Nominee', nomineePhone: '9876500000', nomineeRelation: 'Parent', guardianName: '', guardianPhone: '', assignedAgent: 'Unassigned', consentCaptured: false, documentReferences: '', registrationDate: '2026-08-22' };
